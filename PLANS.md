...
## OpenTUI 内蔵コンソール無効化
- [x] 仕様更新: SPEC-d27be71b に内蔵コンソール無効化要件を追記
- [x] 計画/タスク更新: SPEC-d27be71b plan.md/tasks.md を反映
- [x] TDD: OpenTUI レンダラー設定で内蔵コンソール無効化を検証
- [x] 実装: OpenTUI レンダラー設定に内蔵コンソール無効化を適用
