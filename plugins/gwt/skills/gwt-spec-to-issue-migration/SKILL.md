...
description: "Migrate GitHub Issue-based specs to local SPEC directories. Supports reverse migration from `gwt-spec` Issues to local `specs/SPEC-{id}/` directories using the bundled migration script."
---
