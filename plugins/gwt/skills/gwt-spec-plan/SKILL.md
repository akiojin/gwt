---
name: gwt-spec-plan
description: "Generate `plan.md`, `research.md`, `data-model.md`, `quickstart.md`, and `contracts/*` planning artifacts for an existing `gwt-spec`, including a constitution check against `memory/constitution.md`. Use directly or through `gwt-spec-ops`."
---
