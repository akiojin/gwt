...
pub use persistence::{
    ...
    resolve_workspace_id_for_session, retroactive_auto_done_scan, retroactive_auto_done_scan_paths,
    save_workspace_projection, save_workspace_projection_to_path,
