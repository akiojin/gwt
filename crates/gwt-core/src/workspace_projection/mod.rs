...
pub use persistence::{
    ...
    mutate_existing_workspace_projection_for_cleanup, mutate_workspace_projection,
    mutate_workspace_projection_at, rebuild_work_items_from_events_for_repo,
    ...
    record_workspace_work_paused_event_paths, repair_resume_owner_bleed_for_repo,
    repair_resume_owner_bleed_paths, reset_legacy_agent_identity_at,
    reset_legacy_agent_identity_for_repo, resolve_workspace_id_for_mention,
    resolve_workspace_id_for_session, resolve_workspace_state_external_commit,
    resolve_workspace_state_external_commit_at, resolve_workspace_work_event_from_board_entry,
    retroactive_auto_done_scan, retroactive_auto_done_scan_paths, save_workspace_projection,
    save_workspace_projection_to_path, save_workspace_work_items_projection_to_path,
    transact_workspace_state, transact_workspace_state_at, transact_workspace_state_at_with_commit,
    transact_workspace_state_with_commit, try_resolve_workspace_assignment_for_session,
    ...
    ExternalWorkspaceCommitDecision, ExternalWorkspaceCommitResolution, PruneAction,
    PruneSkipReason, PruneSummary, ResumeOwnerBleedRepairReport,
    SessionBoundWorkspaceMutationTarget, SessionBoundWorkspaceTerminalTarget, StaleReason,
