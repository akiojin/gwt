...
mod tests {
    use super::{
        app_js, branch_cleanup_modal_js, index_html, window_docking_js, xterm_css, xterm_fit_js,
        xterm_js,
    };
    use super::{
        app_js_handler, branch_cleanup_modal_js_handler, window_docking_js_handler,
