...
fn audit_managed_hook_configs(
    ...
    // Provider configuration follows PM instruction discovery, while Session
    // identity and repository Git hooks remain rooted in the project checkout.
    ...
    audit_managed_git_hooks(&input.worktree_root, health);
}
