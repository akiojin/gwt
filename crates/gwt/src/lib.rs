...
pub use issue_monitor::{
    ...
    issue_monitor_prefs_path_for_repo_path, load_issue_monitor_prefs, save_issue_monitor_prefs,
    scan_issue_monitor_candidates, scan_issue_monitor_candidates_with_provenance,
    AutonomousIssueRecord, AutonomousPhase, AutonomousReviewDispatch, EligibilityDecision,
    FailureClass, IssueMonitorCandidateSource, IssueMonitorConfig, IssueMonitorFailedIssue,
