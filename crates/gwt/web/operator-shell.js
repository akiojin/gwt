...
function createActionRegistry(doc) {
  ...
  const seed = [
    ...
    { id: "intake-session", label: "Intake session", hint: "Ephemeral", group: "Workflow", handler: dispatch("intake-session") },
    { id: "open-existing-branch", label: "Open existing branch", hint: "Continue", group: "Workflow", handler: dispatch("open-existing-branch") },
