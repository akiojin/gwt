...
- Artifact refresh: `2026-04-07T08:59:57Z`
...
- Codex panes now use the same PTY-owned scroll path even without explicit SGR mouse-mode negotiation, and gwt hides its local scrollbar overlay whenever the visible agent viewport is no longer represented by local snapshot metrics.
