...
5. Run the focused ServiceSelect, PortSelect, and container lifecycle checks before treating the Docker UI slice as advanced.
...
- Any missing behavior is logged against the remaining `19` unchecked tasks.
