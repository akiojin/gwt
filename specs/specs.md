...
| SPEC ID | タイトル | 作成日 | ステータス |
| --- | --- | --- | --- |
| [SPEC-1350124a](SPEC-1350124a/spec.md) | 機能仕様: Windows シェル選択（Launch Agent / New Terminal） | 2026-02-19 | 実装中 |
...
| [SPEC-ba3f610c](SPEC-ba3f610c/spec.md) | 機能仕様: プロジェクトモード | 2026-01-22 | 更新中 |
