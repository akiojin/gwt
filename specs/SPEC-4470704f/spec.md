...
3. **前提条件** プロジェクトが開かれている、**操作** ネイティブ `View > Toggle Sidebar` を実行する、**期待結果** サイドバー表示が切り替わる
4. **前提条件** プロジェクトが開かれている、**操作** ネイティブ `Settings > Preferences...` を実行する、**期待結果** Settings タブが開く
...
- **FR-400**: アプリケーションはネイティブメニューバー（File/Edit/View/Window/Settings/Help）を提供**しなければならない**
