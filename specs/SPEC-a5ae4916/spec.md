...
1. **前提条件** 最新コミット時刻が設定されたブランチが3本存在する、**操作** ブランチ一覧を表示する、**期待結果** 各行の右端に「最終更新: YYYY-MM-DD HH:mm」が表示され、3つ全ての行で確認できる
...
- **FR-002c**: システムは、各ブランチ行に最新コミット時刻を「最終更新: YYYY-MM-DD HH:mm」形式で表示**しなければならない**
