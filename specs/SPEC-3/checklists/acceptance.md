...
- [x] `59/59` task progress is reflected in `progress.md` and related notes.
...
- [x] The artifact set now consistently describes dedicated version selection
  and launch materialization.
- [x] The artifact set now consistently describes the restored branch-first wizard flow and its no-Confirm step machine.
- [x] The artifact set now consistently describes the restored old-TUI
  option-list formatting slice.
- [x] The artifact set now consistently describes the restored Quick Start
  history data path, grouped old-TUI layout, and resume/start-new semantics.
- [x] The artifact set now consistently describes the restored old-TUI popup
