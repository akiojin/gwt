...
- [x] `14/44` task progress is reflected in `progress.md` and related notes.
- [x] The artifact set now explicitly calls out the gap between the backend bus and the finished TUI routing policy.
