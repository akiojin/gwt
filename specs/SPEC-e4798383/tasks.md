...
- [ ] **T113** [US1] crates/gwt-cli/src/tui/screens/wizard.rs のrender_confirm_step()にIssue情報表示を追加
...
- [ ] **T401** [US4] generate_branch_name_from_issue()が全BranchType（Feature, Bugfix, Hotfix, Release）に対応していることを確認
- [ ] **T402** [P] [US4] 各BranchTypeでのブランチ名生成のユニットテストを追加

**注**: 基本実装（US1）で全タイプ対応済みのため、テストによる確認のみ
...
- [ ] **T701** [統合] cargo build --release でビルドエラーなしを確認
- [ ] **T702** [統合] cargo test で全テストを実行し、既存テストが全てパスすることを確認
- [ ] **T703** [統合] cargo clippy --all-targets --all-features -- -D warnings でLintチェック
- [ ] **T704** [統合] cargo fmt でフォーマット確認
...
- [ ] **T708** [統合] 全変更をConventional Commits形式でコミット
- [ ] **T709** [統合] git push でリモートリポジトリにプッシュ
