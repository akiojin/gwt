...
3. **前提条件** AI設定が無効（APIキー未設定）、**操作** セッション要約タブに切り替え、**期待結果** 「Configure AI in Settings to enable session summary」のような設定促進メッセージが表示される
...
- **FR-042**: システムは、AI設定が無効な場合、`Configure AI in Settings to enable session summary`のような設定促進メッセージを表示**しなければならない**
