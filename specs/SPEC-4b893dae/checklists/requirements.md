...
- [ ] CHK041 FR-041: 表示形式とハイライト必須項目（依頼(元)/直近の指示/決定事項/除外/ステータス/進捗/次(ユーザーの1アクション)/要確認(質問)/要点3語）が明確
- [ ] CHK041a FR-041c: ハイライト件数の可変表示と省略しない方針が明確
...
- [ ] CHK046b FR-046b: セッション要約タブのマウスホイールスクロールが明確
...
- [ ] CHK118 SC-009: 60秒ポーリング精度（±5秒）が測定可能
