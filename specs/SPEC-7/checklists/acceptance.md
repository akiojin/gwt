...
- [x] `8/24` task progress is reflected in `progress.md` and related notes.
- [x] The artifact set now records that the settings surface is present but voice-setting completeness is still pending.
