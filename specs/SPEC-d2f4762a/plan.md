...
**仕様ID**: `SPEC-d2f4762a` | **対象US**: 0, 0b, 0c, 4 | **日付**: 2026-01-20
...
- マウス移動でブランチ一覧のカーソル行を更新し、クリックでEnter相当の選択を行う。一覧領域外/ポップアップ表示中のマウス移動・クリックは無視する。
...
7a) **マウス選択**: ブランチ一覧のマウス移動イベントでカーソル行を更新し、クリックでEnter相当の選択を実行する。ポップアップ表示中は無効化する。
