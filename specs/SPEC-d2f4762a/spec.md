...
1. **前提条件** ブランチ一覧に長いパスのブランチが存在する、**操作** そのブランチにカーソルを移動する、**期待結果** ヘルプ直上に`Branch: refs/heads/feature/very-long-branch-name`（リモートの場合は`refs/remotes/origin/...`）のようにフルパスが表示される
