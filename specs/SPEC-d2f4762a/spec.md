...
13. **前提条件** ブランチ一覧が表示されている、**操作** 画面を確認する、**期待結果** Mode(tab)行の直下に安全アイコンの凡例行が表示され、`Legend: ! Uncommitted  ! Unpushed  * Unmerged` が読める
...
- **FR-034a**: システムは、Mode(tab)行の直下に安全アイコンの凡例行（`Legend: ! Uncommitted  ! Unpushed  * Unmerged`）を表示**しなければならない**
