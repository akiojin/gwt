...
**価値**: gwt-integrationプラグインが自動的に利用可能になる
...
- [x] **T504** [統合] エッジケース（不正JSON、権限エラー等）のテストを追加

### ドキュメント

- [x] **T505** [P] [ドキュメント] `CLAUDE.md` にプラグイン自動登録機能の説明を追加 (スキップ: spec.mdに詳細記載済み)

### コミット

- [x] **T506** [デプロイ] すべての変更をコミット＆プッシュ
