...
## 追加作業: 背景ウィンドウ名の簡素化 (2026-01-23)

### T-033: 背景ウィンドウ名をブランチ名に統一 ✅

- **ファイル**: `crates/gwt-cli/src/tui/app.rs`
- **内容**:
  - [x] 非表示ペインの背景ウィンドウ名にブランチ名のみを使用する
  - [x] 余計なプレフィックスや置換を行わない
- **依存**: T-029
- **テスト**: T-TEST-033
...
### T-TEST-033: 背景ウィンドウ名の生成テスト ✅

- [x] 非表示ペインの背景ウィンドウ名がブランチ名のみになることを確認する
