...
| T-004 | `gwt-project-index` が available skills に露出し、Issue/SPEC 検索用途を説明する | FR-005, FR-007 |
| T-005 | spec 統合要求時に `gwt-project-index` を先に使う workflow 要件を検証できる | FR-006, FR-008 |
