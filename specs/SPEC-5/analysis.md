...
- Notes: The remaining implementation gaps are still the ones called out in
  `spec.md`: semantic search, markdown-rendered detail parity, and
  section-scoped markdown editing. Completion-gate review remains future work
  after those gaps are either implemented or explicitly de-scoped.
