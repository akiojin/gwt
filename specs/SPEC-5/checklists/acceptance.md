...
- [x] `43/43` task progress is reflected in `progress.md` and related notes.
- [x] The artifact set now records that local SPEC management is reachable from the live shell again.
