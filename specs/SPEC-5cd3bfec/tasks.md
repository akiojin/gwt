...
[US1]: ./spec.md#ユーザーストーリー-1---タブで設定セクションを切り替える-優先度-p0
[US2]: ./spec.md#ユーザーストーリー-2---初期表示で-appearance-タブが選択されている-優先度-p0
[US3]: ./spec.md#ユーザーストーリー-3---タブ切り替え後に-saveclose-ボタンが常に表示されている-優先度-p0
