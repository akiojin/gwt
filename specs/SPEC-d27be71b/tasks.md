...
- [x] **T322** [US2] T308-T321の後に 共通コンポーネントの統合テスト実施
...
- [x] **T519** [US4] T518の後に 全スクリーンの統合テスト実施
- [x] **T520** [US4] T519の後に 5000ブランチでの最終性能テスト
...
- [x] **T705** [統合] 既存 307+ テストの SolidJS 版への移植状況を確認
- [x] **T706** [統合] T705の後に テストカバレッジ 100% 達成を確認
- [x] **T707** [統合] T706の後に CI でのテスト実行を確認

### 性能検証

- [x] **T708** [統合] 5000ブランチでの最終性能ベンチマーク実施
- [x] **T709** [統合] T708の後に 60fps スクロール目標達成を確認
- [x] **T710** [統合] T709の後に 16ms 入力レイテンシ目標達成を確認
