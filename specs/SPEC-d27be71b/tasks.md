...
- [ ] **T201** [US1] `src/cli/ui/__tests__/solid/BranchListScreen.test.tsx` にテスト骨格を作成
- [ ] **T202** [US1] T201の後に BranchListScreen のユニットテストを実装（選択、スクロール、フィルター）

### 実装

- [ ] **T203** [US1] T202の後に `src/cli/ui/screens/solid/BranchListScreen.tsx` を作成
- [ ] **T204** [US1] T203の後に 5000ブランチでの性能テストを実施（60fps / 16ms 目標）
- [ ] **T205** [US1] T204の後に 既存 `src/cli/ui/screens/BranchListScreen.tsx` との機能パリティ確認
...
- [ ] **T301** [P] [US2] `src/cli/ui/__tests__/solid/components/Header.test.tsx` にテスト作成
...
- [ ] **T306** [P] [US2] `src/cli/ui/__tests__/solid/components/SelectInput.test.tsx` にテスト作成
- [ ] **T307** [P] [US2] `src/cli/ui/__tests__/solid/components/TextInput.test.tsx` にテスト作成

### 実装

- [ ] **T308** [US2] T301の後に `src/cli/ui/components/solid/Header.tsx` を作成
- [ ] **T309** [US2] T302の後に `src/cli/ui/components/solid/Footer.tsx` を作成
