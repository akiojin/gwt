...
3. **前提条件** project を開いているウィンドウ A が表示中、project を開いている B がトレイに非表示、**操作** A で Cmd+\` を押下、**期待結果** B が show+focus され前面に復元される
...
- project を開いている非表示ウィンドウは巡回対象に含め、show+focus で復元する
...
- **FR-010**: ウィンドウ切り替え時、project を開いている非表示（hide 状態）のウィンドウを対象に含め、選択時に show+focus する
...
- **SC-005**: project を開いている非表示ウィンドウが切り替え対象に含まれ、show+focus で復元される
