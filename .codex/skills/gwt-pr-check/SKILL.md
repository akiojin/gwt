...
python3 ".codex/skills/gwt-pr-check/scripts/check_pr_status.py" --repo "."

# Explicit base branch
python3 ".codex/skills/gwt-pr-check/scripts/check_pr_status.py" --repo "." --base develop

# Append machine-readable JSON after the summary
python3 ".codex/skills/gwt-pr-check/scripts/check_pr_status.py" --repo "." --json
```
