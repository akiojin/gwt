...
type ToolType = "claude-code" | "codex-cli";
...
export function BranchDetailPage() {
  ...
  const handleStartSession = async (toolType: ToolType) => {
    ...
    try {
      ...
      setBanner({
        type: "info",
        message: `${toolLabel(toolType)} を起動しました。`,
      });
    } catch (err) {
      setBanner({
        type: "error",
        ...
        <div className="page-hero__actions">
          {canStartSession ? (
            <>
              ...
              >
                {isStartingSession ? "起動中..." : "Claude Codeを起動"}
              </button>
              <button
                type="button"
                ...
                disabled={isStartingSession}
              >
                {isStartingSession ? "起動中..." : "Codex CLIを起動"}
              </button>
            </>
          ) : (
            <button
...
function toolLabel(tool: ToolType) {
  return tool === "claude-code" ? "Claude Code" : "Codex CLI";
}
